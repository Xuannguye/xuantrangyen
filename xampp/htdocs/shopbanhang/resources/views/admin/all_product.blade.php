      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="uploads/product/{{$pro->product_image}}" height="100" with="100"></td>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc xoá sản phẩm này không')" href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class="">
