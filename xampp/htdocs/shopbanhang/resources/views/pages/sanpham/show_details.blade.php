...
<div class="product-details"><!--product-details-->
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										...
										<div class="item active">
										  <a href=""><img src="{{URL::to('/frontend/images/hh2.jpg')}}" alt=""></a>
										  <a href=""><img src="{{URL::to('/frontend/images/hh3.jpg')}}" alt=""></a>
										  <a href=""><img src="{{URL::to('/frontend/images/hh4.jpg')}}" alt=""></a>
										</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<div id="fb-root"></div>
								<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v12.0" nonce="CxhusxYI"></script>
