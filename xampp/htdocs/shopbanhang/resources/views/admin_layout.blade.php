    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{URL::asset('backend/images/2.png')}}">
                <span class="username">
				<?php
...
<script src="{{URL::asset('backend/jQuery/form-validator/jquery.form-validator.min.js')}}"></script>
