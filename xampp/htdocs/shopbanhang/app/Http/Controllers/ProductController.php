...
class ProductController extends Controller
{
    ...
    public function add_product(){
        $this->AuthLogin();
        $cate_product=DB::table('tbl_category_productse')->orderby('category_id','desc')->get();
    ...
    public function all_product(){
        $this->AuthLogin();
        $all_product=Product::join('tbl_category_productse','tbl_category_productse.category_id','=','tbl_product.category_id')
        ->join('tbl_brand_products','tbl_brand_products.brand_id','=','tbl_product.brand_id')->orderby('tbl_product.product_id','desc')->get();
...
//End Function Admin Page
    public function details_product(Request $request,$product_id){
        ...
        ->join('tbl_category_productse','tbl_category_productse.category_id','=','tbl_product.category_id')
        ->join('tbl_brand_products','tbl_brand_products.brand_id','=','tbl_product.brand_id')
        ->where('tbl_category_productse.category_id',$category_id)
