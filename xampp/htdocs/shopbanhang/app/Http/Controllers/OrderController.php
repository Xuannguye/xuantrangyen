...
class OrderController extends Controller
{
	...
	public function print_order_convert($checkout_code){
		...
		<h1><center>Công ty TNHH một thành viên XTY</center></h1>
    ...
    public function view_order($order_code){
		...
		return view('admin.view_order')->with(compact('order_details','customer','shipping','order_details','coupon_function','coupon_number','order','order_status'));
